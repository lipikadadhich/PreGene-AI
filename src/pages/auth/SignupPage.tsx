...
export default function SignupPage() {
  ...
  async function handleSubmit(event: FormEvent) {
    ...
    // NOTE: AuthContext.signup() is a frontend-only placeholder today (see
    // src/context/AuthContext.tsx for how to connect a real backend later).
    // It currently accepts any well-formed details and creates a local session.
  ...
  return (
    <div>
      ...
      <p className="mt-2 text-[15px] leading-relaxed text-ink-500">
        Get started with precision genetic screening for your clinic.
      </p>
        ...
        <div>
          ...
          <input
            ...
            className={cn(
              ...
              errors.fullName ? "border-red-300" : "border-ink-900/10"
            )}
        ...
        <div>
          <label className="flex items-start gap-2.5 text-sm text-ink-700">
            <input
              ...
              className="mt-0.5 h-4 w-4 rounded border-ink-900/20 text-brand-500 focus-visible:ring-2 focus-visible:ring-brand-500"
            />
            <span>
              I agree to the{" "}
